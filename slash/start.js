...
module.exports = {
  ...
  options: [
    {
      name: 'duration',
      description: 'How long the giveaway should last for? (Example: 1m, 1h, 1d)',
      type: ApplicationCommandOptionType.String,
      required: true
    },
    {
      name: 'winners',
      description: 'Insert the amount of Winners!',
      type: ApplicationCommandOptionType.Integer,
      required: true
    },
    {
      name: 'prize',
      description: 'What should the prize be?',
      type: ApplicationCommandOptionType.String,
      required: true
    },
    {
      name: 'channel',
      description: 'Insert a Channel where to start the Giveaway!',
