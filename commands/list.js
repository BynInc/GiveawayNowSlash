...
module.exports.run = async (client, message, args) => {
  ...
  const msg = await message.reply({ embeds: [new Discord.EmbedBuilder().setDescription("Choose an option in the select menu to get started!").setColor("#2F3136").setTimestamp()], components: [row] })
